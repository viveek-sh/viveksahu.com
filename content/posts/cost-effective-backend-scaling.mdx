...
When people think about scaling backend systems, the first instinct is usually to throw a load balancer in front from AWS, GCP, Cloudflare or other providers. It's the obvious move, these tools exist precisely for this.

But they are not always the most cost-effective one, especially at scale There’s an interesting middle ground that doesn’t get talked about enough: using edge compute as a smart entry layer.
...
They're built to be absurdly scalable. You can use it as a stateless request distributor in front of your backend. CF Workers can insane amount of request seamlessly.
...
Find me on [X](https://x.com/viveek_sh) or [LinkedIn](https://www.linkedin.com/in/viveek-sh/)._
